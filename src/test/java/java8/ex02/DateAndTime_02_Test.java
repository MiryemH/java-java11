...
public class DateAndTime_02_Test {
    ...
    public void test_localDate_format() {
        ...
        LocalDate localDate = LocalDate.of(2015,11,03);

        // TODO Formatter la date pour que le test soit passant
        String result = localDate.format(DateTimeFormatter.ofPattern("MM - dd - yyyy"));
    ...
    public void test_with() {
        ...
        LocalDate result = localDate.with(ChronoField.DAY_OF_MONTH, 5);
        result= result.with(ChronoField.YEAR,2015);
        result= result.with(ChronoField.MONTH_OF_YEAR,2);
